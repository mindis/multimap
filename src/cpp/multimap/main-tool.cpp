...
//                                  arguments[SOURCE].as<std::string>(),
//                                  options);
//}
...
// multimap <command> <options> <args>

// multimap help
// multimap stats    <path/to/map>
// multimap import   <options> <path/to/map> <path/to/file_or_directory>
// multimap export   <path/to/map> <path/to/file>
// multimap optimize <options> <path/to/map> <path/to/optimized_map>
// int main(int argc, const char** argv) {
//  po::positional_options_description positional_options;
//  positional_options.add(COMMAND, 1).add(PATH1, 1).add(PATH2, 1);
...
//  // Options
////  po::options_description commands_description("Options");
////  commands_description.add_options()(HELP, "Print this help message and
/// exit.")(
...
////  options_description.add_options()(SOURCE, po::value<std::string>(),
////                                    "Directory or file used as input.")(
////      TARGET, po::value<std::string>(), "Directory or file used as
/// output.")(
...
////       '.').c_str())(NSHARDS, po::value<std::size_t>(),
////                     ("Number of shards to use for a new instance. "
////                      "Default is " +
////                      std::to_string(options.num_shards) + '.').c_str());
