...
/** \fn cmph_uint32 hash(hash_state_t *state, const char *key, cmph_uint32
 * keylen);
...
/** \fn void hash_vector(hash_state_t *state, const char *key, cmph_uint32
 * keylen, cmph_uint32 * hashes);
 *  \param state is a pointer to a hash_state_t structure
 *  \param key is a pointer to a key
 *  \param keylen is the key length
