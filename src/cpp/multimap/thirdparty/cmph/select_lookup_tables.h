...
/*
rank_lookup_table[i] simply gives the number of bits set to one in the byte of
value i.
...
/*
select_lookup_table[i][j] simply gives the index of the j'th bit set to one in
the byte of value i.
For example if i=01010101 in binary then we have :
...
select_lookup_table[i][4] = 255, there is no more than 4 bits set to one in i,
so we return escape value 255.
*/
