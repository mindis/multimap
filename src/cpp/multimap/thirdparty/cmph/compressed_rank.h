...
void compressed_rank_generate(compressed_rank_t *cr, cmph_uint32 *vals_table,
                              cmph_uint32 n);
...
void compressed_rank_dump(compressed_rank_t *cr, char **buf,
                          cmph_uint32 *buflen);
 ...
 *  \brief Support the ability to pack a compressed_rank structure into a
 * preallocated contiguous memory space pointed by cr_packed.
 *  \param cr points to the compressed_rank structure
 *  \param cr_packed pointer to the contiguous memory area used to store the
 * compressed_rank structure. The size of cr_packed must be at least @see
 * compressed_rank_packed_size
 */
 ...
 *  \brief Return the amount of space needed to pack a compressed_rank
 * structure.
 *  \return the size of the packed compressed_rank structure or zero for
 * failures
 */
cmph_uint32 compressed_rank_packed_size(compressed_rank_t *cr);

/** \fn cmph_uint32 compressed_rank_query_packed(void * cr_packed, cmph_uint32
 * idx);
