...
/** \fn void chd_ph_config_set_keys_per_bin(cmph_config_t *mph, cmph_uint32
 * keys_per_bin);
...
/** \fn void chd_ph_config_set_b(cmph_config_t *mph, cmph_uint32
 * keys_per_bucket);
...
/** cmph_uint32 chd_ph_search(void *packed_mphf, const char *key, cmph_uint32
 * keylen);
